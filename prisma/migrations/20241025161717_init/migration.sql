...
-- AddForeignKey
ALTER TABLE `UserCourse` ADD CONSTRAINT `UserCourse_inscriptionId_fkey` FOREIGN KEY (`inscriptionId`) REFERENCES `InscriptionStatus`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
